"""
Main python script for forward_msg
    Created by Kelvin Tan on 06/08/2019
"""

# Do necessary imports:
from telethon import TelegramClient, sync, events
from telethon.tl.types import InputChannel, InputPeerUser, InputPeerChat
import logging
import sys
import yaml
        ...
        for d in client.iter_dialogs():
            ...
            if d.name == config["output_channel_name"]:
                if (config["mode"] in ['1', '4']):
                    ...
                    output_channel_entity = InputPeerUser(d.entity.id, d.entity.access_hash)
